...
const pizzaData = [
  ...
  },
  {
    ...
    price: 10,
    photoName: "pizzas/margherita.jpeg",
    soldOut: false,
  },
  {
    name: "pizza Spinaci",
...
function Menu() {
  // FIXED: Changed 'pizza' to 'pizzas' to match the length check
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>
            Authentic Italian cuisine.  creative dishes to choose
...
// ADDED: Order component because it was missing
